...
#
# Examples:
#   ./cleanup-runs.sh           # Keep 10 most recent runs (with confirmation)
#   ./cleanup-runs.sh -y        # Keep 10 most recent runs (no confirmation)
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo
            echo "Examples:"
            echo "  $0               # Keep 10 most recent runs (with confirmation)"
            echo "  $0 -y            # Keep 10 most recent runs (no confirmation)"
